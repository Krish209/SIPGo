    ...
    >
      <div className="max-w-screen-lg md:mx-auto text-night">
        ...
        <section className="my-4 md:my-8">
          ...
          <p className="mb-2">
            An instructive case study: Bob, a hypothetical investor spent years
            saving, but consistently purchased market peaks just before crashes:
          </p>
          ...
          <p className="mb-2">
            ...
            investment of ~$184K had grown to $1.1M — despite horrendous timing.
            Had he used rupee-cost averaging instead of lump sums, his outcome
            could have reached ~$2.3M.
          </p>
        ...
        <section className="my-4 md:my-8">
          ...
          <p className="mb-2">
            The real driver of wealth is compound interest—your returns generate
            returns. For instance, ₹5 lakh growing at 18% annually over 20 years
            could become ₹1.37 crore.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1 mb-2">
            ...
            <li>
              Markets recover even severe dips over time—buy-and-hold allows you
              to recoup losses faster than keeping cash or bonds.
            </li>
          </ul>
        ...
        <section className="my-4 md:my-8">
          ...
          <ul className="list-disc pl-6 space-y-1 mb-2">
            ...
            <li>
              <strong>Seth Klarman</strong>: Discipline &gt; Timing — compounded
              returns ~20% for decades while ignoring volatility.
            </li>
          </ul>
        </section>
        ...
        <section className="my-4 md:my-8">
          ...
          <ul className="list-disc pl-6 space-y-1 mb-2">
            <li>
              <strong>Powerful Compounding</strong>: Dividends and price growth
              multiply over decades.
            </li>
            <li>
            ...
            <li>
              <strong>Emotional Simplicity</strong>: Reduces anxiety, no need to
              time markets.
            </li>
          </ul>
        </section>
        ...
        <section className="my-4 md:my-8">
          ...
          <ul className="list-disc pl-6 space-y-1 mb-2">
            <li>
              <strong>Tying Up Capital</strong>: Missed opportunities or better
              investments.
            </li>
            <li>
              <strong>Holding Failing Companies</strong>: Blindly holding losers
              like YES Bank or DHFL can ruin portfolios.
            </li>
            <li>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mb-2">
                ...
                pitfalls like trading on emotion or missing key growth periods.
              </p>
            </div>
            <div>
